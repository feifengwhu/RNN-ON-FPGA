...
To overcome this issue, Hochreiter and Schmidhüber proposed, in 1997, a novel approach, called the Long-Short Term Network~\cite{Hoch97}. The next section explains the main idea of this approach~\ref{sec:struct_lstm}, and also how it is trained\ref{sec:training_lstm}, serving as a support basis for the work of this thesis.
