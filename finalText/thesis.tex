...
\supervisor{Second Supervisor}{Ivo JPM Timóteo}
...
\appendix
\include{appendix-remez}
\include{appendix-lstm}
\include{appendix-testLstm}
\include{appendix-readres2}
\include{appendix-transcript}
