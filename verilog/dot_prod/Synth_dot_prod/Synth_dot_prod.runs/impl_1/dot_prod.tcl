...
set rc [catch {
  ...
  add_files -quiet /home/josefonseca/Documents/thesis/verilog/dot_prod/Synth_dot_prod/Synth_dot_prod.runs/synth_1/dot_prod.dcp
...
set rc [catch {
  ...
  write_checkpoint -force dot_prod_physopt.dcp
...
set rc [catch {
  ...
  report_timing_summary -max_paths 10 -file dot_prod_timing_summary_routed.rpt -rpx dot_prod_timing_summary_routed.rpx
...
set rc [catch {
  ...
  phys_opt_design -directive Explore
  write_checkpoint -force dot_prod_postroute_physopt.dcp
  report_timing_summary -warn_on_violation -max_paths 10 -file dot_prod_timing_summary_postroute_physopted.rpt -rpx dot_prod_timing_summary_postroute_physopted.rpx
