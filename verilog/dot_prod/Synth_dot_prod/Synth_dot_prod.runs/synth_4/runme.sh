...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/dot_prod/Synth_dot_prod/Synth_dot_prod.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log dot_prod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dot_prod.tcl
