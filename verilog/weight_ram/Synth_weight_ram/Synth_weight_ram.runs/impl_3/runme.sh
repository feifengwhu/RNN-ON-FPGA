...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/weight_ram/Synth_weight_ram/Synth_weight_ram.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log weightRAM.vdi -applog -m64 -messageDb vivado.pb -mode batch -source weightRAM.tcl -notrace
