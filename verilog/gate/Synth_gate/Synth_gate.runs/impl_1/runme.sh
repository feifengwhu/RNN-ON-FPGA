...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/gate/Synth_gate/Synth_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gate.vdi -applog -m64 -messageDb vivado.pb -mode batch -source gate.tcl -notrace
