...
ax1.set_xticklabels([])
plt.imshow(prevSRout,cmap=plt.cm.gray, interpolation='none', aspect=0.1)		
ax2 = plt.subplot(1,3,2)
ax2.set_xticklabels([])
plt.imshow(prevCAout,cmap=plt.cm.gray, interpolation='none', aspect=0.1)	
ax3 = plt.subplot(1,3,3)
ax3.set_xticklabels([])
plt.imshow(prevPRNGout,cmap=plt.cm.gray,interpolation='none',  aspect=0.1)	
