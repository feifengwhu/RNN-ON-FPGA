...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/network/Synth_virtex/Synth_virtex.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log network.vdi -applog -m64 -messageDb vivado.pb -mode batch -source network.tcl -notrace
