...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/network/Synth_virtex/Synth_virtex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log network.vds -m64 -mode batch -messageDb vivado.pb -notrace -source network.tcl
