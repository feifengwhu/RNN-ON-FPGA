...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/network/Synth/Synth.runs/synth_7'
cd "$HD_PWD"
...
EAStep vivado -log top_network.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_network.tcl
