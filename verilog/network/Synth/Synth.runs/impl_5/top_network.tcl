...
set rc [catch {
  ...
  add_files -quiet /home/josefonseca/Documents/thesis/verilog/network/Synth/Synth.runs/synth_2/top_network.dcp
...
set rc [catch {
  ...
  write_checkpoint -force top_network_physopt.dcp
...
set rc [catch {
  ...
  report_timing_summary -max_paths 10 -file top_network_timing_summary_routed.rpt -rpx top_network_timing_summary_routed.rpx
...
set rc [catch {
  ...
  phys_opt_design -directive Explore
  write_checkpoint -force top_network_postroute_physopt.dcp
  report_timing_summary -warn_on_violation -max_paths 10 -file top_network_timing_summary_postroute_physopted.rpt -rpx top_network_timing_summary_postroute_physopted.rpx
