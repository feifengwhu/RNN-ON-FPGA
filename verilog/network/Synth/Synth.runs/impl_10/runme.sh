...
HD_PWD='/home/josefonseca/Documents/thesis/verilog/network/Synth/Synth.runs/impl_10'
cd "$HD_PWD"
...
EAStep vivado -log top_network.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_network.tcl -notrace
